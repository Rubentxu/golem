...
// ObservableComplete wraps Adapter.Complete with OTel GenAI spans (ADR-068)
...
// Both span and event carry the same correlation_id so they are queryable together.
//
// Parameters:
...
// Real adapters should use actual token counts from usage metadata.
