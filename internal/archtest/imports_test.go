...
var vendorDenyList = []string{
	...
	"github.com/aws",               // ObjectStore (ADR-014, ADR-083: AWS managed)
	...
	"github.com/prometheus",        // SLO/metrics exporter (M8, ADR-080)
	"github.com/coreos",            // go-oidc JWT validation (M8, ADR-082)
	"github.com/aws/aws-sdk-go-v2", // AWS managed services (M8, ADR-083)
